...
import frame1 from "../../images/Frame 30.svg";

const Home = () => {
  return (
    <div className="pl-[110px] pt-[90px] w-full h-full bg-[#1D2123] relative z-0 max-md:pl-0">
      <div className="flex max-md:flex-col">
        <div className="ml-20 mt-10 rounded-[54px]">
          <img
            src={frame}
            alt=""
            className="min-w-[686px] h-[373px] max-md:hidden"
          />
          <img src={frame1} alt="" className="w-[367px] h-[503px] md:hidden" />
        </div>
        <div className="">
          <p className="mt-10 ml-8  text-white text-[24px] font-bold max-md:flex">
            Top sharts
          </p>
