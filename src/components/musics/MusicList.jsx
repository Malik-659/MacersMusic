    ...
    <div className="pl-[120px] pt-[90px] w-[100%] bg-[#1D2123] pb-16">
      <div className="flex pl-9 pt-4">
          ...
          <div className="ml-8 mt-24" >
            ...
            <p className="text-white text-[14px] font-light mt-4 mb-2">Lorem ipsum dolor sit amet, consectetur adipiscing elit ut aliquam, purus sit amet luctus venenatis</p>
            <p className="text-white text-[14px] font-light">64 songs ~ 16 hrs+</p>
            <div className="flex items-center mt-9"> 
              ...
              <div className="flex items-center justify-around w-[150px] h-[38px] bg-[#FFFFFF12] rounded-[30px] mr-8 ml-8 " >
                <img src={Square} alt="" />
                <p className="text-[12px] font-normal text-white">add to collection</p>
              </div>
