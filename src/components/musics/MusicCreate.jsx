        ...
        <div className="flex justify-around  items-center">
          ...
          <div className="flex flex-col items-center bg-[]">
            <input
              ...
              className="bg-[#1A1E1F] w-[28.125rem] h-[2.5rem] rounded-3xl mt-8 text-gray-200 outline-none pl-[25px]"
            />
            <input
              type="text"
              placeholder="Фото"
              ...
              className="bg-[#1A1E1F] w-[28.125rem] h-[2.5rem] rounded-3xl mt-5 text-gray-200 outline-none pl-[25px]"
            />
            <input
              type="text"
            ...
            <button
              onClick={createMusic}
              className="w-[9.375rem] h-[2.5rem] bg-[#1A1E1F] mt-4 rounded-[15px] text-white "
            >
              Add Music
            </button>
          </div>
